...
class Attendance:
    def __init__(self,root):
        ...
        img=Image.open(r"C:\Users\Ayush\OneDrive\Documents\Face Recognition Attendance System\Images\Attendance1.jpg")
        img=img.resize((800,200), Image.ANTIALIAS)
        self.photoimg=ImageTk.PhotoImage(img)
        f_lbl=Label(self.root,image=self.photoimg)
        f_lbl.place(x=0,y=0,width=800,height=200)

        img1=Image.open(r"C:\Users\Ayush\OneDrive\Documents\Face Recognition Attendance System\Images\Attendance2.jpg")
        ...
        img_left=Image.open(r"C:\Users\Ayush\OneDrive\Documents\Face Recognition Attendance System\Images\AttendanceL.jpg")
        ...
        self.atten_status["values"]=("Status", "Presnt", "Absent")
